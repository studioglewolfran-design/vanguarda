    ...
    <main className="min-h-screen overflow-x-hidden bg-[#F3F3F2] text-[#151419]">
      ...
      <article className="mx-auto max-w-[var(--content-width)] px-5 pb-24 sm:px-8">
        ...
        <header className="grid gap-7 border-b border-[#8A8588]/55 py-12 sm:py-16 lg:grid-cols-[minmax(0,1fr)_220px] lg:items-end lg:gap-12">
          ...
          <p className="border-l-2 border-[#526A7A] pl-5 text-base leading-7 text-[#526A7A]">Base de entendimento para o piloto de 25/09, os contratos do projeto e o primeiro ciclo de validação da plataforma.</p>
        </header>
        ...
        <section aria-label="Atualização desta versão" className="my-8 grid border-y border-[#512334]/45 py-5 sm:grid-cols-[190px_1fr] sm:gap-7">
          <div>
            ...
            <p className="mt-3 font-sans text-2xl font-medium tracking-[-0.04em]">O que mudou.</p>
          </div>
          <div>
            <p className="text-base leading-7 text-[#2C2D33]">A colaboração de Bruno foi delimitada como uma entrega específica de formalização, e não como participação automática no faturamento da ativação. Também foram registrados os limites de validação, a proteção de método, repertório, contatos e dados, e a lógica de uso gratuito e comissão da plataforma.</p>
            <p className="mt-4 border-t border-[#512334]/25 pt-4 font-mono text-xs leading-6 uppercase tracking-[0.1em] text-[#512334]">Fonte: resposta escrita de Bruno Lujan ao alinhamento do Studio, documento “Bruno e Gle — parceria e projetos”, recebido em 10.09.2026.</p>
          </div>
        </section>
          ...
          <div>
            ...
            <section id="frentes" className="border-b border-[#8A8588]/45 py-10 sm:py-14">
              ...
              <div className="mt-8 grid gap-8 border-t border-[#8A8588]/45 pt-6 lg:grid-cols-2 lg:gap-12">
                <article className="border-l-2 border-[#512334] pl-5 sm:pl-6">
                  <p className="font-mono text-xs uppercase tracking-[0.15em] text-[#512334]">Frente 01 · Studio Gle Wolfran</p>
                  <h3 className="mt-4 font-sans text-2xl font-medium leading-tight tracking-[-0.04em]">Design e gestão da ativação</h3>
                ...
                <article className="border-l-2 border-[#526A7A] pl-5 sm:pl-6">
                  <p className="font-mono text-xs uppercase tracking-[0.15em] text-[#526A7A]">Frente 02 · Produto em validação</p>
                  <h3 className="mt-4 font-sans text-2xl font-medium leading-tight tracking-[-0.04em]">Sistema para gestores de eventos</h3>
                  <div className="mt-5 space-y-4 text-base leading-7 text-[#2C2D33]">
            ...
            <section id="cronograma" className="border-b border-[#8A8588]/45 py-10 sm:py-14">
              <div className="flex flex-wrap items-end justify-between gap-4">
                ...
                <span className="font-mono text-xs uppercase tracking-[0.12em] text-[#526A7A]">Linha do tempo viva</span>
              </div>
              ...
              <ol className="relative mt-8 space-y-4 border-l-2 border-[#526A7A] pl-6 sm:pl-8">
                {timeline.map(([date, title, detail], index) => (
                  <li key={date} className="relative">
                    <span aria-hidden="true" className={`absolute -left-[2.15rem] top-1.5 size-3 rounded-full border-2 border-[#F3F3F2] ${index === 0 || index === 2 ? "bg-[#512334]" : "bg-[#526A7A]"}`} />
                    <article className="pb-3">
                      <div className="flex flex-wrap items-baseline gap-x-4 gap-y-1">
                        <span className={`font-mono text-xs uppercase tracking-[0.14em] ${index === 0 || index === 2 ? "text-[#512334]" : "text-[#526A7A]"}`}>{date}</span>
            ...
            <section id="pendencias" className="py-10 sm:py-14">
              ...
              <div className="mt-14 max-w-sm border-t border-[#8A8588]/55 pt-4 text-sm leading-6 text-[#526A7A]">
                ...
                <p className="mt-2">Base de trabalho em consolidação. Cada experiência, indicação, entrega técnica e relação com cliente terá escopo e contrato próprios antes de gerar obrigação.</p>
              </div>
            </section>
          </div>
        </div>

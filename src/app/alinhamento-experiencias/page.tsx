      ...
      <article className="mx-auto max-w-[var(--content-width)] px-5 pb-24 sm:px-8">
        <header className="grid gap-8 border-b border-[#8A8588]/55 py-14 sm:py-20 lg:grid-cols-[minmax(0,760px)_180px] lg:justify-between lg:gap-16">
          <div>
            ...
            <p className="mt-7 max-w-2xl text-lg leading-8 text-[#596862]">Um ponto de partida comum para a experiência de 25/09, o serviço de ativação de marca e o sistema para gestores de eventos.</p>
          </div>
          <aside className="border-l-2 border-[#596862] pl-5 text-sm leading-6 text-[#596862] lg:mt-2">
            <p className="font-semibold text-[#151419]">Este documento não é um contrato.</p>
        ...
        <div className="grid gap-16 lg:grid-cols-[180px_minmax(0,760px)] lg:gap-16">
          <nav aria-label="Nesta página" className="pt-10 lg:sticky lg:top-8 lg:self-start">
            ...
            <div className="mt-4 grid gap-2 text-sm text-[#596862]">
              ...
              <Link href="#protecao" className="transition hover:text-[#512334]">05 · Proteção</Link>
              <Link href="#proximo-passo" className="transition hover:text-[#512334]">06 · Próximo passo</Link>
            </div>
          </nav>
          ...
          <div>
            <section id="contexto" className="border-b border-[#8A8588]/40 py-12 sm:py-16">
              ...
              <div className="mt-6 max-w-2xl space-y-5 text-base leading-7 text-[#2C2D33]">
                ...
                <p className="border-l-2 border-[#512334] pl-5 font-medium text-[#151419]">O sistema pode apoiar esse trabalho. Ele não é o trabalho em si.</p>
              </div>
            </section>
            ...
            <section id="frentes" className="border-b border-[#8A8588]/40 py-12 sm:py-16">
              ...
              <p className="mt-5 max-w-2xl text-base leading-7 text-[#596862]">Separar as camadas deixa a colaboração mais leve e evita que uma contrapartida seja confundida com outra.</p>

              <div className="mt-8 grid gap-4">
                <article className="border border-[#512334] bg-[#512334] p-6 text-[#F3F3F2] sm:p-7">
                  <div className="flex flex-wrap items-baseline justify-between gap-4 border-b border-[#F3F3F2]/20 pb-5">
                    <h3 className="font-sans text-2xl font-medium tracking-[-0.04em]">Design e gestão da ativação de marca</h3>
                    <span className="font-mono text-[10px] uppercase tracking-[0.16em] text-[#F4C3CC]">Serviço do Studio</span>
                  </div>
                  <p className="mt-5 max-w-2xl text-base leading-7 text-[#DDE0E2]">Uma oferta própria de Gleide: pesquisa, curadoria, repertório, conceito, jornada, colaboradores, padrão de qualidade e gestão da ativação quando esse escopo for contratado.</p>
                </article>

                <article className="border border-[#493735]/35 bg-[#DDE0E2] p-6 text-[#493735] sm:p-7">
                  <div className="flex flex-wrap items-baseline justify-between gap-4 border-b border-[#493735]/20 pb-5">
                    <h3 className="font-sans text-2xl font-medium tracking-[-0.04em]">Sistema para gestores de eventos</h3>
                    <span className="font-mono text-[10px] uppercase tracking-[0.16em] text-[#4B354D]">Projeto em construção</span>
                  </div>
                  <p className="mt-5 max-w-2xl text-base leading-7 text-[#2C2D33]">Uma ferramenta para organizar clientes, fornecedores, escopos, contratos e operação. Bruno entra com a construção técnica; Gleide entra com contexto, pesquisa, testes, validação, acessos e uso como primeira cliente.</p>
                  <p className="mt-5 font-mono text-[10px] uppercase tracking-[0.14em] text-[#4B354D]">Uso gratuito e comissão pertencem à lógica da plataforma.</p>
                </article>
              </div>
            </section>
            ...
            <section id="25-setembro" className="border-b border-[#8A8588]/40 py-12 sm:py-16">
              ...
              <p className="mt-5 max-w-2xl text-base leading-7 text-[#596862]">O evento já está valendo. O que ainda está em validação é o desenho da experiência, não a importância de realizá-la.</p>
            ...
            <section id="troca" className="border-b border-[#8A8588]/40 py-12 sm:py-16">
              ...
              <div className="mt-5 border-l-4 border-[#596862] bg-[#DDE0E2] px-6 py-6 sm:px-8 sm:py-7">
                ...
                <div className="mt-5 max-w-2xl space-y-4 text-base leading-7 text-[#2C2D33]">
                  ...
                  <p className="font-semibold text-[#151419]">Nenhum percentual de Bruno na ativação será definido antes de entendermos qual entrega ele deseja assumir nela.</p>
                </div>
              </div>
            </section>

            <section id="protecao" className="border-b border-[#8A8588]/40 py-12 sm:py-16">
              <div className="flex items-start gap-4">
                <div className="mt-1 grid size-9 shrink-0 place-items-center rounded-[4px] border border-[#4B354D]/40 text-[#4B354D]"><LockKeyhole className="size-4" aria-hidden="true" /></div>
                <div>
                  <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-[#4B354D]">05 · Proteção</p>
              ...
              <p className="mt-6 max-w-2xl text-base leading-7 text-[#596862]">O projeto precisa de abertura suficiente para acontecer e de limites suficientes para preservar o repertório, os acessos e a autonomia do Studio.</p>
              <ul className="mt-7 grid gap-3 sm:grid-cols-2">
                {protectionPoints.map((point) => (
                  <li key={point} className="flex gap-3 border-t border-[#8A8588]/40 pt-4 text-sm leading-6 text-[#2C2D33]">
                    <Check className="mt-1 size-4 shrink-0 text-[#4B354D]" aria-hidden="true" />
                    <span>{point}</span>
                  </li>
                ))}
              </ul>
            ...
            <section id="proximo-passo" className="py-12 sm:py-16">
              <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-[#512334]">06 · Próximo passo</p>
              ...
              <p className="mt-5 max-w-2xl text-base leading-7 text-[#596862]">O próximo movimento é consolidar a experiência do dia 25 e apresentar o desenho a participantes e colaboradores. Com os papéis compreendidos, fazemos o contrato com Maria Clara e registramos o que pode virar requisito do sistema.</p>
